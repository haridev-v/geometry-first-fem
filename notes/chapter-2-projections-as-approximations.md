...
Index meaning:- $i$ : which test direction we enforce orthogonality against (row index)- $j$ : which basis function contributes to the approximation $u_h$ (column index)
